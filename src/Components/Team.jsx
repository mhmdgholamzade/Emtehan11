    ...
    <section className="team padding" id="team" data-scroll-index="4">
        <div className="container">
            ...
            <div className="row mt-30">
                ...
                <div className="col-md-6 col-lg-3 col-sm-6 mx-auto">
                    <div className="team-info">
                        <img src="public/team/team-01.jpg" alt="team-photo"/>
                ...
                <div className="col-md-6 col-lg-3 col-sm-6 mx-auto">
                    <div className="team-info">
                        <img src="public/team/team-02.jpg" alt="team-photo"/>
                        <div className="view-content">
                ...
                <div className="col-md-6 col-lg-3 col-sm-6 mx-auto">
                    <div className="team-info">
                        <img src="public/team/team-03.jpg" alt="team-photo"/>
                        <div className="view-content">
                            <h3 className="title">James Smith</h3>
                ...
                <div className="col-md-6 col-lg-3 col-sm-6 mx-auto">
                    <div className="team-info">
                        <img src="public/team/team-04.jpg" alt="team-photo"/>
                        <div className="view-content">
                            <h3 className="title">Emily</h3>
                            <span className="post">Coordinator</span>
                            <ul className="icon">
                                <li><a href="#0"><i className="fa fa-facebook fa-fw"></i></a></li>
                                <li><a href="#0"><i className="fa fa-twitter fa-fw"></i></a></li>
                                <li><a href="#0"><i className="fa fa-instagram fa-fw"></i></a></li>
